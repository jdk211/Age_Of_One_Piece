...
class bullet_usopp: public gameNode { // Projectiles
public:
	struct index {
		float time;
		float delay;
...
class archer_usopp: public unit_archer
{
public:

private:
	vector<bullet_usopp> _bullet;
...
public:
	...
	*/
	...
	vector<bullet_usopp> getBullet() { return _bullet; }
	bullet_usopp getBulletNum( int i ) { return _bullet[i]; }
};