...
class bullet_kizaru : public gameNode{ // Projectiles
public:
...
class archer_kizaru : public unit_archer
{
public:

private:
	vector<bullet_kizaru> _bullet_kizaru;
...
public:
	...
	*/
	...
	vector<bullet_kizaru> getBullet() { return _bullet_kizaru; }
	bullet_kizaru getBulletNum(int i) { return _bullet_kizaru[i]; }
